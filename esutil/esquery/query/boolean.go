...
type BoolQuery struct {
	must               []common.Mappable
	filter             []common.Mappable
	mustNot            []common.Mappable
	should             []common.Mappable
...
// Must add one or more queries of type "must" to the bool query. Must can be
// called multiple times, queries will be appended to existing ones.
func (q *BoolQuery) Must(must ...common.Mappable) *BoolQuery {
...
func (q *BoolQuery) Filter(filter ...common.Mappable) *BoolQuery {
...
// can be called multiple times, queries will be appended to existing ones.
func (q *BoolQuery) MustNot(mustnot ...common.Mappable) *BoolQuery {
	q.mustNot = append(q.mustNot, mustnot...)
	return q
}

// Should add one or more queries of type "should" to the bool query. Should can be
// called multiple times, queries will be appended to existing ones.
func (q *BoolQuery) Should(should ...common.Mappable) *BoolQuery {
